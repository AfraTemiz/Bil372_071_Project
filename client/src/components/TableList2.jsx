...
function FilterableTableList({
  rows, visibleColumns, comp, manageTo, unique, addTo,
}) {
    ...
    <div>
      <div className="filters">
        ...
        {visibleColumns.includes('GIDER_TUTAR') && (
          <input
            type="text"
            placeholder="Filter by cost amount"
            value={filterG_tutar}
        ...
        {visibleColumns.includes('GIDER_TARIH') && (
          <input
            type="text"
            placeholder="Filter by cost date"
            value={filterG_tarih}
      ...
      <table>
        <thead>
          <tr>
            <th> </th>
            {visibleColumns.includes('MALZEME_ADI') && <th>Material Name</th>}
            {visibleColumns.includes('MALZEME_ID') && <th>Material ID</th>}
            {visibleColumns.includes('MALZEME_BIRIM') && <th>Material Unit</th>}
            {visibleColumns.includes('STOK') && <th>Stock</th>}
            {visibleColumns.includes('GIDER_ID') && <th>Cost ID</th>}
            {visibleColumns.includes('GIDER_TUTAR') && <th>Cost Amount</th>}
            {visibleColumns.includes('GIDER_ADI') && <th>Cost Name</th>}
            {visibleColumns.includes('GIDER_TARIH') && <th>Cost Date</th>}
          </tr>
        </thead>
        <tbody>
